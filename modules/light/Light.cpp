 ...
 */
static int32_t BRIGHTNESS_RAMP[RAMP_STEPS] = {0, 14, 28, 42, 56, 70, 84, 100};
...
static void handleNotification(const LightState& state) {
    ...
    if (state.flashMode == Flash::TIMED) {
        /*
         * Calculate the pauseLo value based from the flashOnMs,
         * the number of ramp steps and the step duration.
...
static std::map<Type,
        std::function<void(const LightState&)>> lights = {
